...
export default function RegisterScreen() {
    ...
    const { request: registerRequest, loading: isRegistering, error } = useLazyApi<{ id: string; email: string }>('auth/register', 'POST');
    ...
    const handleSignUp = async () => {
        ...
        try {
            ...
            await toast.promise(
                registerRequest('auth/register', data),
                {
                    loading: { title: 'register.loading', },
                    success: { title: 'register.success', },
                    error: { title: 'register.error', },
                }
            );
